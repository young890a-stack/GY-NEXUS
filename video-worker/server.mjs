...
const server=createServer(async(request,response)=>{
  if(request.method==="GET"&&request.url==="/health")return send(response,200,{ok:true,service:"gy-nexus-video-worker",version:"v3-4-production-1.0.0",activeJobId,queuedJobs});
